...
declare global {
  ...
  // Upstream: import("../../toolkit/content/widgets/browser-custom-element.mjs").MozBrowser.
  // That file lives in the Firefox tree, which this copy does not carry, so the
  // hand-crafted XULBrowserElement from older lib.gecko.tweaks.d.ts stands in.
  ...
  type MozBrowser = XULBrowserElement;
}
