...
export function RSSAction() {
    ...
    <xul:hbox id="rssPageAction" data-l10n-id="rss-page-action"
     ...
     <xul:panel id="rss-panel" type="arrow" position="bottomright topright" onpopupshowing="gSsbSupport.functions.setImageToInstallButton();">
     <xul:vbox id="rss-box">
       <xul:hbox id="rss-content-hbox">
        <xul:vbox id="rss-content-label-vbox">
        <h2>
          <xul:label id="rss-content-label">"https://example.com/"のRSSを受信しますか？</xul:label>
         </h2>
